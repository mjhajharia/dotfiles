...
CN_Hessian = hessian_df_cholesky[!, "CN_Hessian"];
CN_Hessian_nc = hessian_df_cholesky_nc[!, "CN_Hessian"];
CN_Hessian_cholesky = hessian_df_cholesky[!, "CN_Transformed_Hessian"];
CN_Hessian_cholesky_nc = hessian_df_cholesky_nc[!, "CN_Transformed_Hessian"];

CN_Hessian_PCA = hessian_df_PCA[!, "CN_Transformed_Hessian"];
CN_Hessian_PCA_nc = hessian_df_PCA_nc[!, "CN_Transformed_Hessian"];

CN_Hessian_ZCA = hessian_df_ZCA[!, "CN_Transformed_Hessian"];
CN_Hessian_ZCA_nc = hessian_df_ZCA_nc[!, "CN_Transformed_Hessian"];
