...
bs.set_bridgestan_path('/home/meenaljhajharia/.bridgestan/bridgestan')
...
try:
    ...
    bsmodel = bs.StanModel.from_stan_file(stan_filename, data, stanc_args=[f"--include-paths='/home/meenaljhajharia/github/mjhajharia/simplex-transforms/'"])
