...
unc_sample_array, _ = preprocessing_pdb_draws("eight_schools_noncentered", "eight_schools-eight_schools_noncentered", true)

__, bs_model = preprocessing_pdb_draws("eight_schools_centered", "eight_schools-eight_schools_centered", false)
...
CSV.write(fullpath("~/github/mjhajharia/diagnosing-hmc/data/eight_schools-eight_schools_centered/pdb_unc_sample_array.csv"), Tables.table(unc_sample_array));
CSV.write(fullpath("~/github/mjhajharia/diagnosing-hmc/data/eight_schools-eight_schools_centered/cholesky.csv"), cholesky_hessian_df);
CSV.write(fullpath("~/github/mjhajharia/diagnosing-hmc/data/eight_schools-eight_schools_centered/ZCA.csv"), ZCA_hessian_df);
CSV.write(fullpath("~/github/mjhajharia/diagnosing-hmc/data/eight_schools-eight_schools_centered/PCA.csv"), PCA_hessian_df);