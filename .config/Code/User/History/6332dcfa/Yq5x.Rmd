---
title: "Bayesian Data Analysis course - Aalto 2021"
date: "Page updated: `r format.Date(file.mtime('Aalto2021.Rmd'),'%Y-%m-%d')`"
---
...
**Aalto 2021** course will be completely online (pre-recorded lectures, live zoom QA sessions, course chat, online TA sessions, assignments and project submitted online, project presentation online). The registration for the course lectures will be used to estimate the need for the online resources. If you are unable to register for the course at the moment in the Sisu, there is no need to email the lecturer. You can start taking the course and register before the end of the course. Sisu shows rooms on campus for the computer exercises, but all the computer exercises and TA sessions are online. You can choose which TA session to join each week separately, without a need to register for those sessions.
 ...
 - [MyCourses](https://mycourses.aalto.fi/course/view.php?id=32457) is used for important announcements, linking to peergrade, and some questionnaires.
...
- [MyCourses](https://mycourses.aalto.fi/user/index.php?id=28239) is used for important announcements, linking to Zulip and Peergrade, and some questionnaires.
- The primary communication channel is the Zulip course chat (link in MyCourses)
    ...
    - Stream **#queue** is used as a queue for getting help during [TA sessions](assignments.html#TA_sessions).
...
- If you find errors in material, post in **#feedback** stream or [submit an issue in github](https://github.com/avehtari/BDA_course_Aalto/issues).
...
- Make and submit [Assignment 1](assignments/assignment1.pdf). **Deadline Sunday 19.9. 23:59**
...
- Make and submit [Assignment 2](assignments/assignment2.pdf). **Deadline Sunday 26.9. 23:59**
	...
	- [TA sessions](assignments.html#TA_sessions) 22.9 14-16, 23.9 12-14, 24.9 10-12
...
- Make and submit [Assignment 3](assignments/assignment3.pdf). **Deadline Sunday 3.10. 23:59**
...
- [TA sessions](assignments.html#TA_sessions) 29.9 14-16, 30.9 12-14, 1.10 10-12
...
- Make and submit [Assignment 4](assignments/assignment4.pdf). **Deadline Sunday 10.10. 23:59**
...
- [TA sessions](assignments.html#TA_sessions) 6.10 14-16, 7.10 12-14, 8.10 10-12
...
- Make and submit [Assignment 5](assignments/assignment5.pdf). **Deadline Sunday 17.10. 23:59**
...
- [TA sessions](assignments.html#TA_sessions) 13.10 14-16, 14.10 12-14, 15.10 10-12
...
- Make and submit [Assignment 6](assignments/assignment6.pdf). **Deadline Sunday 31.10. 23:59** (two weeks for this assignment)
...
- [TA sessions](assignments.html#TA_sessions) 20.10 14-16, 21.10 12-14, 22.10 10-12
...
- Make and submit [Assignment 7](assignments/assignment7.pdf). **Deadline Sunday 14.11. 23:59** (two weeks for this assignment)
...
- [TA sessions](assignments.html#TA_sessions) 3.11 14-16, 4.11 12-14, 5.11 10-12
...
- [TA sessions](assignments.html#TA_sessions) 10.11. 14-16, 11.11. 12-14, 12.11. 10-12
...
- Additional reading material
    - [Model selection](https://avehtari.github.io/modelselection/)
    - [Cross-validation FAQ](https://avehtari.github.io/modelselection/CV-FAQ.html)
- Make and submit [Assignment 8](assignments/assignment8.pdf). **Deadline Sunday 21.11. 23:59**
...
- [TA sessions](assignments.html#TA_sessions) 17.11 14-16, 18.11 12-14, 19.11 10-12
...
- Make and submit [Assignment 9](assignments/assignment9.pdf). **Deadline Sunday 28.11. 23:59**
...
- [TA sessions](assignments.html#TA_sessions) 24.11 14-16, 25.11 12-14, 26.11 10-12
...
- [TA sessions](assignments.html#TA_sessions) 1.12 14-16, 2.12 12-14, 3.12 10-12
...
- [TA sessions](assignments.html#TA_sessions) 8.12 14-16, 9.12 12-14, 10.12 10-12
