...
\newboolean{showwork}
\newboolean{showpersonal}

\setboolean{showwork}{true} % Set to true to display work entries
\setboolean{showpersonal}{true} % Set to true to display personal entries
...
% {   \foreach \Month in {December,November,October,September,August,July,June,May,April,March,February,January}
%     {   \foreach \Day in {31,...,1}
...
{   
    ...
    {   
        \foreach \Day in {31,...,1}
        {   \ifnum\showWork=1
            \IfFileExists{\Year/\Month/\Day_work.tex} % Check if work file exists
            {
                \createSectionIfNotExists{\Month}
                \openin\mysourceWork=\Year/\Month/\Day_work.tex
                \read\mysourceWork to \firstlineWork
                \closein\mysourceWork
                \xdef\writetitle{1}
                \DTMsavedate{mydate}{\Year-\monthToInt{\Month}-\Day}
                \par % Start a new line for each entry
                \begin{loggentry}{
                    \DTMusedate{mydate}
                }
                {\firstlineWork}
                \xdef\writetitle{0}
                    \input{\Year/\Month/\Day_work}
                    \lhead{\Month}
                \end{loggentry} 
            }
            {}
            \else 
            \fi
            \ifnum\showPersonal=1
            \IfFileExists{\Year/\Month/\Day_personal.tex} % Check if personal file exists
            {
                \createSectionIfNotExists{\Month}
                \openin\mysourcePersonal=\Year/\Month/\Day_personal.tex
                \read\mysourcePersonal to \firstlinePersonal
                \closein\mysourcePersonal
                \xdef\writetitle{1}
                \DTMsavedate{mydate}{\Year-\monthToInt{\Month}-\Day}
                \par % Start a new line for each entry
                \begin{loggentry}{
