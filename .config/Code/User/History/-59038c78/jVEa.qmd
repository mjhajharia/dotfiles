...
plot = scatter!(CN_Hessian_nc, CN_Hessian_cholesky_nc, xaxis=:log, yaxis=:log, alpha=0.1, label="Non-Centered Eight Schools", font="Palatino Linotype")

display(hessian_transformed_plot((plot),"Cholesky"));
```
