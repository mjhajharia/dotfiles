...
### Note
- `dogs-dogs`, `dogs−dogs_log` is missing from PosteriorDB reference posteriors
-  `eight_schools_centered` is missing from PosteriorDB reference posteriors, so we created the centered draws from the noncentered draws.
