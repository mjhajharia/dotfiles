...
### Note
- `dogs-dogs`, `dogs−dogs_log` missing from PosteriorDB reference posteriors
-  `eight_schools_centered` missing from PosteriorDB reference posteriors, so we created the centered draws from the noncentered draws.
