...
ZCA = eigenv.vectors * Diagonal(1 ./ sqrt.(eigenv.values)) * eigenv.vectors';
PCA = Diagonal(1 ./ sqrt.(eigenv.values)) * eigenv.vectors';
eigenv_nc = eigen(cov(unc_sample_array_nc));
ZCA_nc = eigenv_nc.vectors * Diagonal(1 ./ sqrt.(eigenv_nc.values)) * eigenv_nc.vectors';
PCA_nc = Diagonal(1 ./ sqrt.(eigenv_nc.values)) * eigenv_nc.vectors';
```
